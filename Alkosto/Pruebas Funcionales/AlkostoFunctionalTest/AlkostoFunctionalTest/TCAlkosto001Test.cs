...
namespace SeleniumTests
{
    ...
    public class TCAlkosto001Test
    {
        ...
        public void TheTCAlkosto001Test()
        {
            // ERROR: Caught exception [ERROR: Unsupported command [loadVars | Data001.csv | ]]
            ...
            string producto = TestContext.DataRow["producto"].ToString();
